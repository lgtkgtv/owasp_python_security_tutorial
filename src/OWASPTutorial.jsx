...
import { AlertCircle, CheckCircle, XCircle, Shield, Terminal, Code, Code2, BookOpen, Trophy, ChevronRight, Home, Lock, Eye, Database, Menu, X, RefreshCw, FolderOpen, PackageX, FileWarning, Globe, Settings, EyeOff, Syringe, Radar, PackageSearch, FlaskConical, FileOutput, Bot, KeyRound, Network, Megaphone, Infinity, Fingerprint, Boxes, ScrollText } from 'lucide-react';
...
const OWASPSecurityTutorial = () => {
  ...
  if (currentModule === 'sqlinjection') {
    ...
    return <BrokenAccessControlModule
      onBack={() => setCurrentModule(null)}
    ...
    return <VulnerableComponentsModule
      onBack={() => setCurrentModule(null)}
...
// ============================================================================
// A01:2021 - BROKEN ACCESS CONTROL (IDOR) MODULE
// ============================================================================
...
// ============================================================================
// A06:2021 - VULNERABLE & OUTDATED COMPONENTS MODULE
// ============================================================================
...
// ============================================================================
// A09:2021 - SECURITY LOGGING & MONITORING FAILURES MODULE
// ============================================================================
